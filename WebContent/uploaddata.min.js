...
function uploadSpeexData(e) {
    var t = (e[0], (new Date).getTime()),
        a = mAppSecret + "api=" + mApi + "appkey=" + mAppKey + "timestamp=" + t + mAppSecret, r = $.md5(a),
        n = mUrl + "?appkey=" + mAppKey + "&api=" + mApi + "&timestamp=" + t + "&sign=" + r + "&seq=" + mSeq + "&compress=1";
    if (window.FileReader) {
        var i = new FileReader;
        i.readAsArrayBuffer(e), i.onloadend = function () {
            var e = new Uint8Array(this.result), t = e.subarray(0), a = new Int16Array(t.buffer),
                r = new Speex({quality: 10, mode: 1, bits_size: 70}), i = r.encode(a, !0), l = new Blob(i),
                s = new FileReader;
            s.readAsArrayBuffer(l), s.onloadend = function () {
                $.ajax({
                    url: n,
                    data: this.result,
                    type: "POST",
...
function getServerResult(e) {
    var t = e + "&stop=1";
    $.ajax({
        url: t, type: "GET", dataType: "json", async: !1, xhrFields: {withCredentials: !0}, success: function (e) {
...
var mUrl, mAppKey, mApi, mAppSecret, mSeq, callBack, interval, intervalCount = 0;